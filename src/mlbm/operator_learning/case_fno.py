...
from mlbm.validator import GridValidator
from mlbm.datasets.karman_street_dataset import KarmanStreetDataset, MixedReKarmanStreetDataset
...
def main(cfg: DictConfig):
    ...
    dataset_train = MixedReKarmanStreetDataset(
    ...
    dataset_val = MixedReKarmanStreetDataset(
        base_folder=cfg.data.base_folder,
        Re_list=[125, 175],
        field_name=cfg.data.field_name,
        num_channels=cfg.data.num_channels,
    ...
    # dataset_val, _ = random_split(
    #     dataset_val, [0.6, 0.4], generator=torch.Generator().manual_seed(42)
    # )
