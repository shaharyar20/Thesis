...
class ThermalMacroscopicQuantityCalculationModule(nn.Module):
    ...
    def __init__(self, lattice_velocities: List[List[float]]) -> None:
        ...
        """
        super(ThermalMacroscopicQuantityCalculationModule, self).__init__()
    ...
    def forward(self, node_data: ThermalNodeData) -> ThermalNodeData:
        ...
        node_data.moments.temperature = torch.sum(node_data.distributions.temp_old_population, dim=0)
        return node_data
