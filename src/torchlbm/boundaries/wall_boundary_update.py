...
class WallBoundaryUpdate(nn.Module):
    ...
    def __init__(
        ...
        """
        super(WallBoundaryUpdate, self).__init__()
    ...
    # fmt: off
    def update_east_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_west_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_north_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_south_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_top_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_bottom_wall(self, population: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
