...
class OutletBoundaryUpdate(nn.Module):
    ...
    def __init__(
        ...
        is_east_outlet: bool,
        is_west_outlet: bool,
        is_north_outlet: bool,
        is_south_outlet: bool,
        is_top_outlet: bool,
        is_bottom_outlet: bool,
        num_halo_cells: int,
        ...
        Args:
            is_east_outlet (bool): Inidicator whether the east part of the computational domain is a wall.
            east_outlet_velocity (torch.Tensor): The wall velocity of the east part of the computational domain.
            is_west_outlet (bool): Inidicator whether the west part of the computational domain is a wall.
            west_outlet_velocity (torch.Tensor): The wall velocity of the west part of the computational domain.
            is_north_outlet (bool): Inidicator whether the north part of the computational domain is a wall.
            north_outlet_velocity (torch.Tensor): The wall velocity of the north part of the computational domain.
            is_south_outlet (bool): Inidicator whether the south part of the computational domain is a wall.
            south_outlet_velocity (torch.Tensor): The wall velocity of the south part of the computational domain.
            is_top_outlet (bool): Inidicator whether the top part of the computational domain is a wall.
            top_outlet_velocity (torch.Tensor): The wall velocity of the top part of the computational domain.
            is_bottom_outlet (bool): Inidicator whether the bottom part of the computational domain is a wall.
            bottom_outlet_velocity (torch.Tensor): The wall velocity of the bottom part of the computational domain.
        ...
        self.is_east_outlet = is_east_outlet
        self.is_west_outlet = is_west_outlet
        self.is_north_outlet = is_north_outlet
        self.is_south_outlet = is_south_outlet
        self.is_top_outlet = is_top_outlet
        self.is_bottom_outlet = is_bottom_outlet
    ...
    def update_east_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
        ...
        for east_index in self.east_velocities:
            ...
            population[
                ...
                self.access_indices[2][1] if self.dimension == 3 else 0:
                self.access_indices[2][2] if self.dimension == 3 else 1,
            ] = - f_slice + 2.0 * weight * outlet_density * (1.0 + 0.5 * 9.0 * wall_velocity_projection**2 - 0.5 * 3.0 * square_velocity_projection)
        return population

    def update_west_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_north_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_south_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_top_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
    ...
    def update_bottom_outlet(self, population: torch.Tensor, velocity: torch.Tensor, density: torch.Tensor) -> torch.Tensor:
