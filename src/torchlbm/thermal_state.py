...
class ThermalTorchlbmState:
    ...
    def __init__(self, torchlbm_setup: TorchlbmSetup, initial_condition: TorchlbmInitialCondition, logger: Logger) -> None:
        ...
        self.relaxation_omega_temp = 1.0 / (3*self.torchlbm_setup["Thermal"]["HeatConductivity"].value + 0.5)
        ...
        equilibrium_module = ThermalEquilibriumCalculationModule(
        ...
        self.node_data: ThermalNodeData = ThermalNodeData(
            ...
            moments=Moments(initial_density, velocity_profile, initial_temperature, torch.zeros_like(velocity_profile), torch.zeros_like(velocity_profile)),
