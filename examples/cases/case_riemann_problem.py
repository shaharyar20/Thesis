...
def main():
    ...
    simulation_setup = TorchlbmSetup("RiemannProblem")
    simulation_setup["Domain"]["Dimension"].value = "2D"
    simulation_setup["Domain"]["NodeSize"].value = N  #2 * torch.pi
    simulation_setup["Domain"]["CellsPerNode"].value = N
    ...
    simulation_setup["Thermal"]["ThermalConductivity"].value = 0.005*3.5/0.71
    simulation_setup["Thermal"]["Cp"].value = 3.5
    simulation_setup["Thermal"]["Cv"].value = 2.5
    simulation_setup["Thermal"]["Viscosity"].value = 0.005
    simulation_setup["Thermal"]["ShiftedVelocityX"].value = 0.4
    simulation_setup["Thermal"]["ShiftedVelocityY"].value = 0.4
    ...
    simulation_setup["Physics"]["EndTime"].value = 800.0
